      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
            什么是 <span className="text-gradient">Critical</span>？
          </h2>
          <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
            Critical 是一款革命性的沉浸式骑行模拟设备。通过风速、灯光、音效、雾化四维感官联动，
            将室内骑行训练台升级为身临其境的赛道体验。无论是专业训练、展厅展示还是内容创作，
            Critical 都能为你带来前所未有的沉浸感。
          </p>
        </motion.div>
        ...
        >
          <div className="aspect-[16/9] rounded-2xl bg-dark-700/50 border border-white/5 overflow-hidden flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm">产品渲染图</p>
              <p className="text-gray-600 text-xs mt-1">替换为实际产品图片</p>
            </div>
          </div>
          {/* Glow effect */}
