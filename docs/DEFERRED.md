...
**当前**：home / admin / SEO / 404（基础 smoke）。

**待补**：

- [ ] Lead 提交全流程（含真实 SMTP mock）
- [ ] Checkout 全流程（PayPal sandbox）
- [ ] Admin 退款 / 发货 全流程
- [ ] 固件 OTA check / download 全流程
- [ ] 切换语言 / 主题（避免 hydration 问题）
- [ ] 移动端 viewport（Pixel 5 / iPhone 13）
...
- [ ] vitest 加 `coverage: { thresholds: { ... 70 } }`
- [ ] CI 跑 `pnpm test --coverage`，低于阈值红条
